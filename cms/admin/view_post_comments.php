                ...
                <tbody>
                    ...
                    if (isset($_GET['p_id'])) {
                        ...
                        while ($row = mysqli_fetch_assoc($comments_query)) {
                            ...
                            echo "<td><a href='view_post_comments.php?delete={$comment_id}&id={$post_id}'>Delete Comment</a></td>";
                            echo "</tr>";
                        }
                    }
...
if (isset($_GET['approve'])) {
    ...
    header("Location: view_post_comments.php?p_id={$the_post_id}");
}
